...
class ReportAccountFinancialReport(models.Model):
    ...
    analytic2 = fields.Boolean('Allow analytic 2 filter', help='display the analytic 2 filter')
    partner = fields.Boolean('Allow Partner filter', help='display the partner filter')
    ...
    def get_options(self, previous_options=None):
        ...
        self.filter_analytic2 = True if self.analytic2 else None
        self.filter_partner = True if self.partner else None
    ...
    def create_action_and_menu(self, parent_id):
        ...
        module = self._context.get('install_mode_data', {}).get('module', 'ac_reports')
...
class AccountFinancialReportLine(models.Model):
    ...
    def _get_with_statement(self, financial_report):
        ...
        if self.code not in ('CASHSTART', 'CASHEND') \
          and (financial_report == self.env.ref('ac_reports.account_financial_report_cashsummary0') or self.env.context.get('cash_basis')):
